...
public class MyLogger{
    ...
    */
    ...
    public static enum DebugLevel {NO_OUTPUT, MATCH, OBJECT, CONSTRUCTOR, FILE_O
                                   };
	...
	switch (levelIn) {
	  case 4: debugLevel = DebugLevel.FILE_O; break;
    case 3: debugLevel = DebugLevel.CONSTRUCTOR; break;
    case 2: debugLevel = DebugLevel.OBJECT; break;
    case 1: debugLevel = DebugLevel.MATCH; break;
